    ...
    >
      ...
      >
        {/* ── The crown, on first place, on this slide too ──
            ...
            **Drawn after the disc, so it sits in front of it** — the opposite
            of `/podium`, and deliberately. There the crown is 34% of a 280px
            mark, and overlapping one would cover a real fraction of the
            artwork, so it tucks behind the rim. Here the mark is 86px and the
            crown is 29, sitting at eleven o'clock on a disc whose monogram is
            centred — in front it covers a sliver of the disc's edge and nothing
            that identifies the venture. Behind, at this size, it read as a gold
            shape stuck to the *back* of the mark rather than resting on it.
